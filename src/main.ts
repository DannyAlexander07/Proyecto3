document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addEventListener("load", () => {
    ...
    // Timeline
    const wrapper = document.querySelector<HTMLElement>('#timeline-horizontal .timeline-wrapper');
    const track   = document.querySelector<HTMLElement>('#timeline-horizontal .timeline-track');
    const items   = Array.from(document.querySelectorAll<HTMLElement>('#timeline-horizontal .timeline-item'));
    const prevBtn = document.querySelector<HTMLButtonElement>('#prev-year');
    const nextBtn = document.querySelector<HTMLButtonElement>('#next-year');
